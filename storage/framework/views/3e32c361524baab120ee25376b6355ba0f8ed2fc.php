                ...
                <div class="panel panel-orange panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-10 col-lg-9 widget-right">
                            <div class="large"><?php echo e($pending['appointment']); ?></div>
                ...
                <div class="panel panel-blue panel-widget ">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            <div class="large"><?php echo e($patients->count()); ?></div>
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                <div class="panel panel-teal panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            <div class="large"><?php echo e($total_test); ?></div>
            ...
            <div class="col-xs-12 col-md-6 col-lg-3">
                <div class="panel panel-red panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            <div class="large"><?php echo e($total_doctor); ?></div>
                        ...
                        <table id="table" class="display table table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>₹<?php echo e(number_format($invoice->total_amount)); ?></td>
                                 ...
                                 <tr>
                                    ...
                                    <th>₹<?php echo e(number_format($total['total_amount'])); ?></th>
                                </tr>                    
                        </table>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                         <table id="example" class="display table table-bordered table-condensed table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($i++); ?></td>
                                    <td><?php echo e($opd->invoice->patient->first_name); ?> <?php echo e($opd->invoice->patient->last_name); ?></td>
                                    <td><?php echo e($opd->doctor->employee->first_name); ?> <?php echo e($opd->doctor->employee->middle_name); ?> <?php echo e($opd->doctor->employee->last_name); ?></td>
                                    <td><?php echo e($opd->created_at); ?></td>
                                    <?php if($opd->status == 1): ?>
                                    <td><span class="btn-sm btn-success glyphicon glyphicon-ok"> Complete</span></td>
                                    <?php else: ?>
                                    <td><a class="btn-sm btn-warining" href="<?php echo e(route('doctor.edit',$opd->id)); ?>"><span class=" glyphicon glyphicon-refresh"> Pending</span></a> </span></td>
                                    <?php endif; ?>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>                 
