...
<?php if(count($errors) > 0): ?>
            ...
            <div class="panel-body">
				<div class="row">
					<div class="col-md-8">
						<!-- services -->
						<div class="row">
						<?php echo e(Form::open(array('route'=>'invoice.store', 'method'=>'post', 'class'=>'form-group'))); ?>
						...
						<div class="col-md-4">
                            ...
                            <div class="col-md-12">
		 		 			...
		 		 			<p>--------------------------------------------------------------------</p>
		 		 				...
		 		 				<a href="<?php echo e(url('invoice')); ?>" class="btn btn-default">Reset</a>
		 		 			</div>	
						</div>
						</div>
						</div>
 ...
 function del(id)
			{
				//alert(id)
				$('#service_sales').load(<?php echo json_encode(url('/invoice/remove')); ?>+'/'+id);
        ...
        $(document).ready( function() {
            ...
            $('#service_id').on('change', function() {
                ...
                //ajax
              $('#service_sales').load(<?php echo json_encode(url('/invoice/sales')); ?>+'/'+service_id);
            });
