            ...
            <div class="panel-body">
				<div class="row">
					<div class="col-md-8">
						...
						<div class="row">
						<?php echo e(Form::open(array('route'=>'package.sale', 'method'=>'post', 'class'=>'form-group'))); ?>
	 		 			...
	 		 			<div class="col-md-4">
                            ...
                            <div class="col-md-12">
		 		 			...
		 		 			<p>--------------------------------------------------------------------</p>
		 		 				...
		 		 				<a href="<?php echo e(url('package/sale')); ?>" class="btn btn-default">Reset</a>
		 		 			</div>	
						</div>
 		 			</div>
 		 			</div>
...
$(document).ready(function() {
  	...
  	$('#doctor_id').on('change', function() {
            ...
            $('#bill').load(<?php echo json_encode(url('/package/sale')); ?>+'/'+doctor_id);
            });
